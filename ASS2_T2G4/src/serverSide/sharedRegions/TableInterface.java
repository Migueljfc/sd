...
public class TableInterface {
    ...
    public Message processAndReply (Message inMessage) throws MessageException
    {
        ...
        switch(inMessage.getMsgType())
        {
            ...
            case MessageType.HAPDREQ:		// Have all clients been served
            case MessageType.DPREQ:				// Deliver portion
            case MessageType.TSREQ:			// Table shutdown
                break;
            ...
            case MessageType.GTPREQ:				// Get the pad
            ...
            case MessageType.HECREQ:		// Has everybody chosen
            case MessageType.AUOCREQ:			// Add up ones choices
            case MessageType.DOREQ:			// Describe order
            case MessageType.HEFREQ:	// Has everybody finished eating
            case MessageType.HBREQ:			// Honour the bill
            case MessageType.HACDREQ:		// Have all courses been eaten
                break;
            ...
            case MessageType.GFSREQ:			//Get first to arrive
            case MessageType.GLSREQ:			//Get last to eat
            case MessageType.STFS:			//Set first to arrive
            case MessageType.STLS:			//Set last to arrive
                break;
            default:
